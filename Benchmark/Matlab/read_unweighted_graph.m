function S = read_unweighted_graph(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as a matrix.
%   FACEBOOKG = IMPORTFILE(FILENAME) Reads data from text file FILENAME for
%   the default selection.
%
%   FACEBOOKG = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data from rows
%   STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   facebookG = importfile('facebookG.txt', 1, 176468);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2017/01/07 22:45:51
